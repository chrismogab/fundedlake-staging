...
function Footer() {
  return (
    <div className="font-lexend bg-[#111]">
      <div class="container w-full max-w-6xl mx-auto px-4 py-4 lg:px-0 lg:py-6">
        ...
        <div className="footerEndCol flex flex-col items-center justify-start mt-6">
          ...
          <ul className="social-icons flex justify-center items-center gap-8 mt-10 mb-4">
            <li className="size-6">
              <a href="https://discord.gg/vDSnjmxndy" target="_blank"><svg
            ...
            <a href="https://www.facebook.com/profile.php?id=61575089499789" target="_blank"><li className="size-6">
              <svg
                fill="#fff"
